...
# === CONFIGURATION ===
MODEL_PATH = r"C:\Users\HP\Documents\Master 2\deep learning\projet_poubelle\modele_poubelle.h5"
...
def main():
    ...
    st.title("🏢 Surveillance Intelligente des déchets ")
        ...
        try:
            with open(MODEL_PATH, "rb") as file:
                st.sidebar.download_button(
                    label="📥 Cliquez pour télécharger le modèle",
                    data=file,
